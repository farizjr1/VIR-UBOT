...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/farizjr1/VIR-UBOT")
...
# Untuk Melihat Repo
REPO_NAME = os.environ.get("REPO_NAME") or "⭐VIR-UBOT⭐"
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "VIR-BOT")
...
IG_ALIVE = os.environ.get("IG_ALIVE") or "instagram.com/farizjlr"
...
GROUP_LINK = os.environ.get(
    "GROUP_LINK") or "t.me/MusicVirGroup"

# Default .repo Bot
OWNER_BOT = os.environ.get(
    "OWNER_BOT") or "t.me/farizjrlr"


# Last.fm Module
BIO_PREFIX = os.environ.get("BIO_PREFIX", None)
DEFAULT_BIO = os.environ.get("DEFAULT_BIO") or "⭐VIR-BOT⭐"
...
BOTLOG_MSG = os.environ.get(
    "BOTLOG_MSG") or "```║DAH AKTIF YA BUJANG!!!🔥🔥║\n\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\nJika Tidak Bisa Di .ping\nSilahkan Anda\nCek viewlogs\nPada heroku Anda.\n▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰```"
...
with bot:
    try:
        ...
        async def opeen(event):
            try:
                ...
                if tgbotusername is not None:
                    results = await event.client.inline_query(tgbotusername, "@VirrU_bot")
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@VirrU_bot"):
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # pylint:disable=E0602
                ...
                reply_pop_up_alert = f"WOI !!! JANGAN PAKE PUNYA {DEFAULTUSER} DONG."
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # @VirrU-bot
                # https://t.me/TelethonChat/115200
                await event.edit(
                    file=ramlogo,
                    link_preview=True,
