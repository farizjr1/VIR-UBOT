    ...
    if HEROKU_API_KEY is not None:
        ...
        if HEROKU_APP_NAME is None:
            await event.edit(
                ...
                ' untuk dapat deploy perubahan terbaru dari VIR-USERBOT.`'
            )
            repo.__del__()
            return
...
CMD_HELP.update({
    'update':
    ".update"
    "\nUsage: Untuk Melihat Pembaruan Terbaru VIR-UBOT."
    "\n\n.update one"
    "\nUsage: Memperbarui VIR-UBOT."
    "\n\n.update all"
    "\nUsage: Memperbarui VIR-UBOT Dengan Cara Deploy Ulang."
})
